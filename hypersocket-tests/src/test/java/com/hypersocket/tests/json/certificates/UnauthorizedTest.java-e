...
public class UnauthorizedTest extends AbstractServerTest {
	...
	public void test01_createCertificate() throws Exception {
		...
		update.setProperties(properties);
		doPostJson("/hypersocket/api/certificates/certificate", update);
	}
	...
	public void test04_testDownloadCSR() throws Exception {
		assertNotEquals(0, certificateID);
		doGet("/hypersocket/api/certificates/downloadCSR/" + certificateID);
	}
	...
	public void test06_testExportPFX() throws Exception {
		...
		JsonResponse json = getMapper().readValue(
				doPost("/hypersocket/api/certificates/exportPfx/"
						+ certificateID, new BasicNameValuePair("passphrase",
						"passsword")), JsonResponse.class);
	...
	public void test07_testExportPEM() throws Exception {
		assertNotEquals(0, certificateID);
		JsonResponse json = getMapper().readValue(
				doPost("/hypersocket/api/certificates/exportPem/"
						+ certificateID, new BasicNameValuePair("passphrase",
						"passsword")), JsonResponse.class);
		assertTrue(json.isSuccess());
	...
	public void test08_testUploadPEM() throws Exception {
		...
		doPostMultiparts("/hypersocket/api/certificates/pem/" + certificateID,
	...
	public void test09_testUploadPFX() throws Exception {
		...
		PropertyObject[] properties = new PropertyObject[] { passphrase };
		doPostMultiparts("/hypersocket/api/certificates/pfx/" + certificateID,
				properties, pfxFile);
