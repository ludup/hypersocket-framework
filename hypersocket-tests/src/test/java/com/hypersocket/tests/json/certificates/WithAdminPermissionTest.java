...
public class WithAdminPermissionTest extends AbstractCertificateTest {
	...
	@Test
	public void test06_testExportPEM() throws Exception {
		assertNotEquals(0, resourceID);
		JsonResponse json = getMapper().readValue(doPost("/hypersocket/api/certificates/exportPfx/"+resourceID,
				new BasicNameValuePair("passphrase", "passsword")), JsonResponse.class);
		assertTrue(json.isSuccess());
