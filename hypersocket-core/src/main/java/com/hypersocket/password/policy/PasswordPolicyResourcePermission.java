...
public enum PasswordPolicyResourcePermission implements PermissionType {
	 ...
	 */
	private final static String name = "passwordPolicy";
	
	private PermissionType[] implies;
	
	private PasswordPolicyResourcePermission(final String val, PermissionType... implies) {
		this.val = name + "." + val;
