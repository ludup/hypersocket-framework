...
public class PluginResourceUpdatedEvent extends
		PluginResourceEvent {

	/**
	 * TODO You typically add attributes to the base PluginResourceEvent
	 * class so these can be reused across all resource events.
	 */
	public static final String EVENT_RESOURCE_KEY = "plugin.updated";

	public PluginResourceUpdatedEvent(Object source,
