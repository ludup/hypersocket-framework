...
public abstract class AbstractAssignableResourceRepositoryImpl<T extends AssignableResource>
	...
	@SuppressWarnings("unchecked")
	@Transactional
	public void bulkAssignRolesToResource(Class<T> clazz, BulkAssignment bulkAssignment) {
		List<T> assignableResources = createCriteria(clazz,	"ar").add(Restrictions.in("ar.id",
